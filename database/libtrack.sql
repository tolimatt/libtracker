...
CREATE TABLE `transactions` (
  ...
  `status` enum('borrowed','reserved','returned') DEFAULT 'reserved',
...
CREATE TABLE `user` (
  ...
  `student_id` int(14) NOT NULL COMMENT 'Student ID "03-2324-xxxxxx"',
  `password` varchar(255) NOT NULL,
  ...
  `contact_number` int(11) NOT NULL COMMENT 'contact number'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
